    ...
    return (
        <div className="bg-[var(--foreground)] rounded-xl p-7 text-white shadow-sm shadow-[var(--text-primary)]/20 border border-white/10 mb-8 relative overflow-hidden">
            ...
            <div className="flex items-start justify-between relative z-10 mb-4">
                ...
                <div className="size-12 rounded-xl bg-[var(--surface-muted)]/30 backdrop-blur-md border border-[var(--border)] flex items-center justify-center">
            ...
            {designDeadline && (
                <div className="bg-[var(--surface-muted)]/20 border border-[var(--border)] rounded-xl p-5 flex items-center justify-between relative z-10 backdrop-blur-sm">
                    <div className="flex items-center gap-3">

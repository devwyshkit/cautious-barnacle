        ...
        <div className="bg-zinc-950 rounded-xl p-7 text-white shadow-sm shadow-zinc-950/20 border border-white/10 mb-8 relative overflow-hidden">
            ...
            <div className="flex items-start justify-between relative z-10 mb-4">
                <div className="space-y-1">
                    ...
                    <p className="text-xs font-bold text-zinc-500 tracking-tight mt-1">
                        Personalisation • Order {orderId.slice(0, 8).toUpperCase()}
                    </p>
                </div>
                <div className="size-12 rounded-xl bg-white/5 backdrop-blur-md border border-white/10 flex items-center justify-center">
            ...
            {designDeadline && (
                <div className="bg-white/5 border border-white/10 rounded-xl p-5 flex items-center justify-between relative z-10 backdrop-blur-sm">
                    <div className="flex items-center gap-3">
                        <div className="size-9 rounded-full bg-rose-500/10 flex items-center justify-center border border-rose-500/20">
                            <Clock className="size-4 text-rose-500" />
                        </div>
                        <div>
                            <p className="text-xs font-black tracking-tight text-white/40 mb-0.5">Approval SLA Baseline</p>
                            <HyperlocalTimer
                    ...
                    <div className="px-3 py-1 bg-white/10 rounded-full border border-white/10">
                        <span className="text-[11px] font-black text-white/60 tracking-tight">Priority</span>
                    </div>
                </div>
            )}
        </div>

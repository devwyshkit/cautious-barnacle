    ...
    return (
        <div className="flex flex-col items-center justify-center p-12 space-y-6 text-center animate-in fade-in zoom-in duration-500 min-h-[400px]">
            ...
            <div className="pt-8">
                <button
                    onClick={onClose}
                    className="h-14 px-8 bg-[var(--text-primary)] text-white rounded-xl font-bold tracking-tight hover:scale-[1.02] active:scale-[0.98] transition-all shadow-sm shadow-[var(--text-primary)]/20"
                >
                    Great, thanks
                </button>
            </div>

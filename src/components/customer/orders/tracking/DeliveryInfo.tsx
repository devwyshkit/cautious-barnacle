                ...
                <div className="surface-card p-4 flex items-center justify-between gap-3">
                    ...
                    {order.tracking_url && (
                        <a
                            ...
                            className="h-10 px-5 rounded-xl bg-zinc-950 text-white text-xs font-black tracking-tight flex items-center justify-center active:scale-95 transition-all shadow-sm shadow-zinc-950/10 border border-zinc-900"
                        >
                            Track
                        </a>
                    )}
            ...
            {order.delivery_address && (
                <div className="surface-card p-4 flex items-start gap-4">
                    ...
                    <div className="flex-1">
                        <p className="text-xs font-black text-zinc-500 tracking-tight mb-1.5 leading-none">Delivery Address</p>
                        ...
                        {((order as any).gstin || (order.delivery_address as any)?.gstin) && (
                            <div className="mt-3 flex items-center gap-2 px-2.5 py-1 rounded-lg bg-zinc-50 border border-zinc-100 w-fit">
                                <span className="text-xs font-black text-zinc-400 tracking-tight">GSTIN:</span>

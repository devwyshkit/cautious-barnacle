        ...
        <section className="group transition-all">
            {totalProducts > 1 && (
                <div className="flex items-center gap-3 mb-4 px-2">
                    <div className="size-8 rounded-[var(--radius-md)] bg-[var(--text-primary)] flex items-center justify-center shadow-lg shadow-[var(--text-primary)]/10">
                    ...
                    {!config.text_required && !config.image_required && (
                        <span className="text-xs font-bold bg-[var(--surface-muted)] text-[var(--text-tertiary)] px-2 py-1 rounded-[var(--radius-sm)] tracking-tight border border-[var(--border)]/50">Optional</span>
                    )}
                </div>
            )}

            <div className="bg-[var(--surface)] rounded-[var(--radius-md)] p-6 border border-[var(--border)] shadow-sm transition-all group-hover:border-[var(--border)] space-y-5">
                {schema ? (
                            ...
                            <div key={field.id} className="space-y-2">
                                ...
                                {field.type === 'text' ? (
                                    <input
                                        ...
                                        className="w-full bg-[var(--surface-muted)] border-[var(--border)] rounded-[var(--radius-md)] p-3 text-sm focus:bg-[var(--surface)] focus:border-[var(--text-primary)] transition-all outline-none border"
                                    />
                                ) : field.type === 'textarea' ? (
                                    <Textarea
                                        value={input[field.id] || ''}
                                        onChange={(e) => onInputChange(field.id, e.target.value)}
                                        placeholder={field.placeholder}
                                        className="w-full bg-[var(--surface-muted)] border-[var(--border)] rounded-[var(--radius-md)] p-3 text-sm focus:bg-[var(--surface)] focus:border-[var(--text-primary)] transition-all outline-none border min-h-[80px]"
                                    />
                                ) : null}
                            </div>
                        ))}
                                ...
                                <div className="flex flex-wrap gap-2 px-1">
                                    {[
                                        ...
                                        <button
                                            ...
                                            className="text-xs font-bold px-2.5 py-1 rounded-[var(--radius-sm)] bg-[var(--surface-muted)] border border-[var(--border)] text-[var(--text-secondary)] hover:bg-[var(--surface-muted)] transition-all active:scale-95"
                                        >
                                            {token.label}
                                        </button>
                                    ))}
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <button
                                        ...
                                        className="flex flex-col items-center justify-center gap-2 py-5 bg-[var(--surface-muted)] border border-[var(--border)] rounded-[var(--radius-md)] hover:bg-[var(--surface-muted)] transition-all active:scale-[0.98] disabled:opacity-50 group/btn"
                                    >
                                    ...
                                    <button
                                        ...
                                        className="flex flex-col items-center justify-center gap-2 py-5 bg-[var(--text-primary)] rounded-[var(--radius-md)] hover:bg-[var(--foreground)] transition-all active:scale-[0.98] disabled:opacity-50 group/btn shadow-lg shadow-[var(--shadow-sm)]"
                                    >
                                ...
                                {input.image_url && (
                                    <div className="relative aspect-video rounded-[var(--radius-md)] overflow-hidden border border-[var(--border)] group shadow-sm bg-[var(--surface-muted)] animate-in zoom-in-95 duration-500">
                                ...
                                {pastMockupUrl && (
                                    <div className="space-y-3 p-4 bg-[var(--well-warning)] rounded-[var(--radius-md)] border border-[var(--warning)]/20">
                                        ...
                                        <div className="relative aspect-video rounded-[var(--radius-sm)] overflow-hidden border border-[var(--border)] shadow-sm">
                ...
                {config.instructions && (
                    <div className="flex gap-2.5 p-4 bg-[var(--surface-muted)]/50 rounded-[var(--radius-md)] border border-[var(--border)]/50">

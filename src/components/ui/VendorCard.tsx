                ...
                <div className="relative aspect-[4/3] w-full overflow-hidden bg-[var(--surface-muted)] rounded-t-[var(--radius-xl)]">
                    {data.image_url ? (
                        ...
                        <div className="flex items-center justify-center h-full bg-[var(--surface-muted)]">
                            <span className="text-xs font-bold text-[var(--text-tertiary)] uppercase tracking-[0.2em]">Vendor</span>
                        </div>
                    )}

                    {prepTime && (
                        <div className="absolute bottom-[var(--space-2)] left-[var(--space-2)] px-[var(--space-2)] py-[var(--space-1)] bg-[var(--surface)]/90 backdrop-blur-md rounded-[var(--radius-sm)] shadow-[var(--shadow-sm)] flex items-center gap-[var(--space-1)] pointer-events-none">
                            <Clock className="size-3 text-[var(--text-primary)]" />
                            <span className="text-xs font-bold text-[var(--text-primary)] tracking-tight uppercase leading-none">{prepTime}</span>
                        </div>
                    )}
                </div>

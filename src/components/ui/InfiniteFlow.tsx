            ...
            <div ref={loaderRef} className="flex justify-center py-12">
                {isLoadingMore ? (
                    <div className="flex flex-col items-center gap-3">
                        ...
                        <p className="text-[10px] font-black text-zinc-400 uppercase tracking-widest">Hydrating Flow...</p>
                    </div>
                ) : !hasMore && items.length > 0 ? (
                    <div className="flex flex-col items-center gap-3 opacity-30">
                        <Sparkles className="size-5 text-zinc-400" />
                        <p className="text-[10px] font-black text-zinc-400 uppercase tracking-widest">End of Discovery</p>
                    </div>
                ) : null}
            </div>
        </div>
